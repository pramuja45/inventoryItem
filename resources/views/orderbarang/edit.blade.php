            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">Edit Order Barang</div>

                            <div class="card-body">
                                <form action="{{ route('orderbarang.update', $order->no_po) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal" id="tanggal" class="form-control" value="{{ $order->tanggal }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kode_supplier" id="kode_supplier" class="form-control" required>
                                            ...
                                            <option value="{{ $supplier->kode_supplier }}" @if($supplier->kode_supplier == $order->kode_supplier) selected @endif>{{ $supplier->kode_supplier }} - {{ $supplier->nama_supplier }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="PPN" id="PPN" class="form-control" value="{{ $order->PPN }}" required>
                                    </div>

                                    <button type="submit" class="btn btn-primary">Simpan</button>
                                    <a href="{{ route('orderbarang.index') }}" class="btn btn-secondary">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
