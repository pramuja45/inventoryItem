            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">Tambah Order Barang</div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('orderbarang.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_po" id="no_po" class="form-control" value="{{ old('no_po') }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="PPN" id="PPN" class="form-control" value="{{ old('PPN') }}" required>
                                    </div>
