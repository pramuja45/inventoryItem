            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">Edit Detail Order Barang</div>

                            <div class="card-body">
                                <form action="{{ route('orderdetail.update', $orderDetail->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_barang" id="nama_barang" class="form-control" value="{{ $orderDetail->nama_barang }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="harga_barang">Harga Barang</label>
                                        <input type="number" name="harga_barang" id="harga_barang" class="form-control" value="{{ $orderDetail->harga_barang }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="kuantiti">Kuantiti</label>
                                        <input type="number" name="kuantiti" id="kuantiti" class="form-control" value="{{ $orderDetail->kuantiti }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="tanggal_simpan">Tanggal Simpan</label>
                                        <input type="date" name="tanggal_simpan" id="tanggal_simpan" class="form-control" value="{{ $orderDetail->tanggal_simpan }}" required>
                                    </div>
