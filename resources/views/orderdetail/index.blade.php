    ...
    <div class="app-wrap">
        ...
        <div class="app-container">
            ...
            <div class="app-main">
                ...
                <div class="card">
                <div class="card-header">Daftar Detail Order Barang</div>

                <div class="card-body">
                    <a href="{{ route('orderdetail.create') }}" class="btn btn-primary mb-3">Tambah Detail Order Barang</a>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $orderDetail->harga_barang }}</td>
                                <td>{{ $orderDetail->kuantiti }}</td>
                                <td>{{ $orderDetail->tanggal_simpan }}</td>
                                <td>
                                    <a href="{{ route('orderdetail.show', $orderDetail->id) }}" class="btn btn-info btn-sm">Show</a>
                                    <a href="{{ route('orderdetail.edit', $orderDetail->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <form action="{{ route('orderdetail.destroy', $orderDetail->id) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
