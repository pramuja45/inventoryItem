            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">Tambah Pengeluaran Barang</div>
                            <div class="card-body">
                                <form action="{{ route('pengeluaran.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tujuan" id="tujuan" class="form-control" value="{{ old('tujuan') }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="kuantity" id="kuantity" class="form-control" value="{{ old('kuantity') }}" required>
                                    </div>
