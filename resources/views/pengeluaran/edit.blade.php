            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <h1 class="my-4">Edit Pengeluaran Barang</h1>
                        <form action="{{ route('pengeluaran.update', $pengeluaran->id_pengeluaran) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_keluar') is-invalid @enderror" id="tanggal_keluar" name="tanggal_keluar" value="{{ old('tanggal_keluar', $pengeluaran->tanggal_keluar) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" name="tujuan" value="{{ old('tujuan', $pengeluaran->tujuan) }}" required>
                                @error('tujuan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                <label for="kuantity">Quantity</label>
                                <input type="number" class="form-control @error('kuantity') is-invalid @enderror" id="kuantity" name="kuantity" value="{{ old('kuantity', $pengeluaran->kuantity) }}" required>
                                @error('kuantity')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kode_barang') is-invalid @enderror" id="kode_barang" name="kode_barang" required>
                                    ...
                                    <option value="{{ $barang->kode_barang }}" {{ $barang->kode_barang == old('kode_barang', $pengeluaran->kode_barang) ? 'selected' : '' }}>
                                        {{ $barang->nama_barang }}
                                    </option>
                                    @endforeach
                                </select>
