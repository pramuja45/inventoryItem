                            ...
                            <div class="card-body">
                                <form action="{{ route('supplier.update', $supplier->kode_supplier) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telepon" id="telepon" class="form-control" value="{{ $supplier->telepon }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="alamat">Alamat</label>
                                        <textarea name="alamat" id="alamat" class="form-control" rows="3" required>{{ $supplier->alamat }}</textarea>
                                    </div>
