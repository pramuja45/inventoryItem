            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">Edit Penerimaan Barang</div>
                            <div class="card-body">
                                <form action="{{ route('penerimaan.update', $penerimaan->id_penerimaan) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_penyimpanan" id="tanggal_penyimpanan" class="form-control" value="{{ old('tanggal_penyimpanan', $penerimaan->tanggal_penyimpanan) }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="alamat">Alamat</label>
                                        <textarea name="alamat" id="alamat" class="form-control" required>{{ old('alamat', $penerimaan->alamat) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kode_barang" id="kode_barang" class="form-control" required>
                                            ...
                                            <option value="{{ $barang->kode_barang }}" {{ $penerimaan->kode_barang == $barang->kode_barang ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="kuantity" id="kuantity" class="form-control" value="{{ old('kuantity', $penerimaan->kuantity) }}" required>
                                    </div>

                                    <button type="submit" class="btn btn-primary">Update</button>
                                    <a href="{{ route('penerimaan.index') }}" class="btn btn-secondary">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
